  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.element} onPress={_onNavigateMyCart}>
        ...
        <Text h5 colorSecondary>{t('orders:text_my_cart')}</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.element} onPress={() => {
        ...
        <Text h5 h5Style={{ color: isChoosen == 'incoming' ? colors.selIcon : colors.border_color }}>{t('orders:text_incoming')}</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.element} onPress={() => {
        ...
        <Text h5 h5Style={{ color: isChoosen == 'outgoing' ? colors.selIcon : colors.border_color }}>{t('orders:text_outgoing')}</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.element} onPress={() => {
        ...
        <Text h5 h5Style={{ color: isChoosen == 'archived' ? colors.selIcon : colors.border_color }}>{t('orders:text_archived')}</Text>
      </TouchableOpacity>
    </View>
  )
}
