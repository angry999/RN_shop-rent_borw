...
import { isValidPassword, isNotContainNumber, isValidEmail, isEqual } from 'src/utils/string';
...
class RegisterScreen extends React.Component {
  ...
  componentDidMount() {
    switch (this.props.language) {
      case this.languages[0].name:
        this.setState({
          lang: this.languages[0].value
        })
        break;
      case this.languages[1].name:
        this.setState({
          lang: this.languages[1].value
        })
        break;
      case this.languages[2].name:
        this.setState({
  ...
  checkFormatFirstName = (value, t) => {
    if (!isNotContainNumber(value)) {
      this.setState({
        error: {
          errors: {
            ...this.state.error.errors,
            firstName: t('error:text_warning_name_contains_number'),
          }
        }
      })
      return;
  ...
  _onChangeLang = (value) => {
    ...
    switch (value) {
      case this.languages[0].value:
        this.props.dispatch(changeLanguage(this.languages[0].name))
        break;
      case this.languages[1].value:
        this.props.dispatch(changeLanguage(this.languages[1].name))
        break;
      case this.languages[2].value:
        this.props.dispatch(changeLanguage(this.languages[2].name))
        break;
      default:
        break;
    }
    ...
    if (!isNotContainNumber(value)) {
      this.setState({
        error: {
          errors: {
            ...this.state.error.errors,
            lastName: t('error:text_warning_name_contains_number'),
          }
        }
      })
      return;
