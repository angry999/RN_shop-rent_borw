      ...
      <View style={styles.container}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.title}>
            ...
            <Text style={{ marginTop: 2, flex: 1 }} h4 bold colorSecondary numberOfLines={1} ellipsizeMode='tail'>{item.name}asdasdasdasdasdasdadasdasadddasdasdasdasdsadasddasdsadasdadsadasdasdsadasdasdasdasddasdadadasdasdasdasdaada</Text>
