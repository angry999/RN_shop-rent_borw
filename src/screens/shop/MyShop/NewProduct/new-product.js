      ...
      <KeyboardAvoidingView
        ...
        <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: H >= 812 ? padding.base : 0 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.containerDelivery}>
            {shouldCourier && <TouchableOpacity style={styles.type} onPress={() => {
              ...
              <Image source={byHand ? icon.optionSelected : icon.optionUnselected}
                style={styles.icon} resizeMode='contain' />
              <Text h5 medium
                style={[styles.text, { marginStart: margin.small, color: !byHand ? colors.border_color : colors.selIcon }]} >
                {t('shop:text_delivery_by_hand')}
              </Text>
            </TouchableOpacity>}

            {shouldHand && <TouchableOpacity style={styles.type} onPress={() => {
              ...
              <Image source={byCourier ? icon.optionSelected : icon.optionUnselected}
                style={styles.icon} resizeMode='contain' />
              <Text h5 medium
                style={[styles.text, { marginStart: margin.small, color: !byCourier ? colors.border_color : colors.selIcon }]} >
