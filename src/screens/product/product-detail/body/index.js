  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerTitle}>
        ...
        {item.owner.id != userId && <Icon
          onPress={() => _onNavigateMessage()}
          containerStyle={{ marginEnd: margin.base + margin.tiny }}
          name='send-o' type='font-awesome'
          color={colors.unSelIcon} size={28} />}
        <TouchableWithoutFeedback onPress={_onBookmarkItem}>
          <Icon name={!bookmarked ? 'bookmark-o' : 'bookmark'} type='font-awesome'
            color={!bookmarked ? colors.unSelIcon : colors.selIcon} size={28} />
