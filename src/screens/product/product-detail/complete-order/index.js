    ...
    <ThemedView isFullView>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          {method == 'by courier' || method == 'By courier' && <Text h4 colorSecondary>{t('shop:text_address')}</Text>}
          {method == 'by courier' || method == 'By courier' && <MapView style={{ marginHorizontal: 0 }} t={t}
          ...
          <View>
            ...
            <View style={styles.item}>
              ...
              {method == 'by courier' ? <Text h4 colorSecondary>{currency}{newFee}</Text> :
