...
// export const API_NUS = 'http://18.132.205.118'; // develope_env
...
export const INVITE_LINK = 'https://onelink.to/borw'

export const GOOGLE_API_KEYS = 'AIzaSyCB18USpPKn0NbcdpbBUFDQNJzRRUn95Dk'
